...
export const AssistantButton = ({ onClick }: AssistantButtonProps) => {
  return (
    <div 
      onClick={onClick}
      className="flex items-center space-x-2 bg-transparent px-3 py-1 rounded-full text-white body-100 font-normal cursor-pointer hover:bg-white/10 transition-colors"
    >
