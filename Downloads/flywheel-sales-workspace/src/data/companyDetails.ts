...
export const companyDetails: Record<string, CompanyDetail> = {
  ...
  "3": {
    id: "3",
    companyName: "Advanced Satellite Communications",
    description: "Advanced Satellite Communications, Inc. (also operating as A.S.C. Security Systems) is a 35-year-old, privately held B2B commercial technology systems integrator. Two revenue lines: commercial entertainment/satellite TV (a DIRECTV commercial VIP dealer) and integrated security systems (cameras, alarms, access control).",
