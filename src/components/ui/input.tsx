    ...
    return (
      <input
        ...
        className={cn(
          ...
          "rounded-[var(--borderRadius-100,4px)] border-[length:var(--borderWidth-100,1px)] border-solid border-[var(--color-border-core-subtle)] bg-[var(--color-fill-field-default)]",
          className
        )}
        ref={ref}
        {...props}
