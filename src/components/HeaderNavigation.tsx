...
export const HeaderNavigation = ({
  ...
  return <header className="fixed top-7 left-0 right-0 w-full h-12 z-50 flex items-center justify-between px-3 shrink-0" style={{ background: "#333333" }} onWheel={(e) => e.stopPropagation()}>
      {/* Left section */}
